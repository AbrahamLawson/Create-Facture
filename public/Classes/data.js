export class Datas {
    constructor(documentType, firstName, lastName, adress, contry, town, zip, product, price, quantity, tva, date) {
        ...
        return `
                <div class="row p-5">
                    ...
                    <div class="col-md-6 text-right">
                        <p class="font-weight-bold mb-1">xxxxxxxxxxxxxxx<span class="font-weight-normal">N ${Math.floor(Math.random())}</span></p>
